...
**Purpose:** Captures research findings for main session review. Created by `/pals:research` or `/pals:research-phase`.
...
*Created by /pals:research. Review before integrating.*
...
1. User runs `/pals:research <topic>`
