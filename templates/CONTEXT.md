...
**Purpose:** Captures user's vision, goals, and approach before planning. Created by `/pals:discuss`, consumed by `/pals:plan`.
...
*Created by /pals:discuss, consumed by /pals:plan.*
```
