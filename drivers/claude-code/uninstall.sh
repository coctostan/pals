...
# ════════════════════════════════════════
# PALS Claude Code Driver Uninstaller
# ════════════════════════════════════════
# Removes Claude Code-specific artifacts from ~/.claude/
# Called by root uninstall.sh before kernel cleanup.
#
# Does NOT remove ~/.pals/ (that's the root uninstaller's job).

echo "  Removing Claude Code driver artifacts ..."
