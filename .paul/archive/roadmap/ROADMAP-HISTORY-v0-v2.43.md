# ROADMAP History Archive v0-v2.43
...
Use this archive when completed milestone detail from v0.1 through v2.43 is needed. Normal `/paul:resume`, `/paul:status`, PLAN/APPLY/UNIFY routing, and current milestone planning should read the compact live `.paul/ROADMAP.md` first.
