# STATE History Archive v0-v2.43

Source: .paul/STATE.md
Archived on: 2026-04-26
Scope: Historical accumulated context moved out of the hot lifecycle state artifact during Phase 185 Plan 185-02. Includes long Decisions, Fixes, Deviations, Skill Audit, and Deferred Issues history through v2.43 planning.
Still authoritative?: Yes — this archive preserves historical PALS project state. The live .paul/STATE.md remains the hot lifecycle routing artifact for current position, loop state, git state, blockers, and session continuity.
Return link: [Live state](../../STATE.md)

## Usage

Use this archive when older decisions, fixes, deviations, or skill-audit history are needed. Normal `/paul:resume`, `/paul:status`, PLAN/APPLY/UNIFY routing, and current blockers should read the compact live `.paul/STATE.md` first.
