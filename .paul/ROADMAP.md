...
| 137 | GitHub Flow Merge Gate Simplification | 1 | ✅ Complete | 2026-03-26 |

### Phase 135: Module Instruction Wording Audit
Focus: Rewrite all 18 module hook descriptions from descriptive to imperative phrasing so non-frontier models execute rather than document (Item 1)
Plans: TBD (defined during /paul:plan)

### Phase 136: Post-Apply/Post-Unify Enforcement
Focus: Structural workflow changes to ensure post-apply and post-unify hooks actually fire across models (Items 2, 4)
Plans: TBD (defined during /paul:plan)

### Phase 137: GitHub Flow Merge Gate Simplification
Focus: Break the monolithic merge gate into smaller, individually addressable steps so more models can execute it (Item 5)
Plans: TBD (defined during /paul:plan)
