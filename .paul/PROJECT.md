...
v2.51 Pi-Native Validation Classification is active as the fifth Pi-native build milestone after v2.46. Phase 220 Documentation + Report Surfacing APPLY is complete and awaiting UNIFY.
...
Recently completed: Phase 220 surfaced validation classification in README, Pi docs, the classification contract, and historical validation reports while preserving command-output truth; validation now passes Pi 202/202 and cross-harness 118/118 after one localized docs/report surfacing guardrail per suite. Current: UNIFY 220-01 should reconcile docs/report surfacing evidence, count changes Pi 201→202 and cross-harness 117→118, module evidence, and Phase 221 readiness while deferring legacy cleanup.
