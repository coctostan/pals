...
Active milestone: **v2.65 Functional-First Agent Guidance** — Phases 279–281 complete; Phase 282 ready to plan. Phase 279 created the authoritative v2.65 contract; Phase 280 added generated AGENTS/init Engineering Principles; Phase 281 added brownfield convention detection for map-codebase/templates while preserving project-convention authority. Latest completed milestone: **v2.64 Module Instruction Audit + Context-Efficiency Rewrite** closed 2026-05-12 via PR #196 (`340eee03`). Prior milestone: **v2.63 Workflow Instruction Audit + Context-Efficiency Rewrite** closed 2026-05-10 via PR #188 (`df56ece1`).
...
| v2.65 Functional-First Agent Guidance | In progress (3 of 5 phases complete) — Phases 279–281 complete; Phase 282 ready to plan | Adds practical “functional-first, not functional-only” agent coding guidance without turning PALS into an FP framework or overriding project conventions. Phase 279 created the authoritative implementation contract; Phase 280 added generated AGENTS/init Engineering Principles plus installed-resource marker checks; Phase 281 added brownfield map-codebase/template signal detection for local idioms and effect boundaries; remaining phases target TODD/RUBY guidance and optional ARCH advisory closure. |
...
Current milestone pointer: **v2.65 Functional-First Agent Guidance** — Phases 279–281 complete; Phase 282 ready to plan. Source of truth for this milestone’s scope is `docs/PALS-FUNCTIONAL-FIRST-AGENT-GUIDANCE-CONTRACT.md`; the research note remains provenance/background.
...
*Last updated: 2026-05-13 after Phase 281 completion; v2.65 Phase 282 ready to plan.*
