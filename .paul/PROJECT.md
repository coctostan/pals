...
| 2026-05-08: Cross-file narrative duplication recorded as deferred debt (3 duplications across hot artifacts). | Phase 265 | Remediation needs an architectural single-source choice; deferred to v2.63+. v2.62 stays bounded to archive-and-compact. |
...
| 2026-06-04: v2.71 HTML Presentation Packets complete — static, derived, non-authoritative review briefs for all four lifecycle moments. | Phases 299–302 (PRs #218/#219/#221/#222, tag `v2.71`) | `docs/PALS-HTML-PRESENTATION-PACKETS-CONTRACT.md` + `kernel/templates/HTML-PRESENTATION-PACKET.md` authoritative; optional/non-blocking generation across milestone/plan/apply/unify; packets static, source-cited, budget-exempt, never change lifecycle state. Detail: [v2.71 archive](archive/roadmap/v2.71-html-presentation-packets.md). |
| 2026-06-05: v2.72 Phase 303 fixed the shared-runtime-helper extraction boundary contract-first. | Phase 303 (`303-01-SUMMARY.md`; PR #223 `ee5a9010`) | `docs/PALS-SHARED-RUNTIME-HELPERS-CONTRACT.md` is authoritative for v2.72: 7 pure/derived helpers + `PalsStateSnapshot` move from `pals-hooks.ts` into a leaf `drivers/pi/extensions/shared-runtime-helpers.ts` (Node `fs`/`path` only); source-verified inventory (8 exports) + importer map (12 sites/8 siblings); stay-put symbols excluded. Extraction = Phase 304, validation = Phase 305. |
...
*Created: 2026-03-11*
*Last updated: 2026-06-05 after v2.72 Phase 303 (shared-runtime-helpers contract, PR #223); Phases 304–305 pending.*
