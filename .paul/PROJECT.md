...
Active milestone: **v2.65 Functional-First Agent Guidance** — Phase 279 complete, Phase 280 ready to plan. Phase 279 created `docs/PALS-FUNCTIONAL-FIRST-AGENT-GUIDANCE-CONTRACT.md` as the authoritative v2.65 implementation boundary, with `docs/FUNCTIONAL-FIRST-AGENT-GUIDANCE-RESEARCH.md` preserved as provenance. Latest completed milestone: **v2.64 Module Instruction Audit + Context-Efficiency Rewrite** closed 2026-05-12 via PR #196 (`340eee03`). Prior milestone: **v2.63 Workflow Instruction Audit + Context-Efficiency Rewrite** completed 2026-05-10 via PR #188 (`df56ece1`).
...
| v2.65 Functional-First Agent Guidance | In progress (1 of 5 phases complete) — Phase 279 complete; Phase 280 ready to plan | Adds practical “functional-first, not functional-only” agent coding guidance without turning PALS into an FP framework or overriding project conventions. Phase 279 created the authoritative implementation contract and preserved the research note as provenance; later phases target AGENTS/init conventions, brownfield mapping, TODD/RUBY guidance, and optional ARCH advisory language. |
...
Current milestone pointer: **v2.65 Functional-First Agent Guidance** — Phase 279 complete; Phase 280 ready to plan. Source of truth for this milestone’s scope is `docs/PALS-FUNCTIONAL-FIRST-AGENT-GUIDANCE-CONTRACT.md`; the research note remains provenance/background.
...
*Last updated: 2026-05-12 after Phase 279 completion; v2.65 Phase 280 ready to plan.*
