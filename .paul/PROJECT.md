...
Active milestone: **v2.66 Plannotator Integration — Rich UI Review Surfaces**. Phases 284–285 are complete: Phase 284 established the authoritative PALS/Plannotator contract, and Phase 285 added the optional/advisory `plannotator-bridge.ts` Pi helper surface with marker validation. Phase 286 is ready to plan workflow integration for opt-in plan review.
...
| v2.66 Plannotator Integration — Rich UI Review Surfaces | Active (2 of 4 phases complete) — Phase 284 closed 2026-05-14 via PR #202; Phase 285 closed 2026-05-14 via PR #203 | Integrates PALS with `@plannotator/pi-extension` for opt-in rich UI review while preserving `.paul/*` lifecycle authority. Phase 284 created `docs/PALS-PLANNOTATOR-UI-INTEGRATION-CONTRACT.md` as the authoritative contract for consumed event/result fields, advisory sidecars, non-adoption, opt-in, failure modes, and validation classification. Phase 285 added the optional/advisory `drivers/pi/extensions/plannotator-bridge.ts` helper surface plus docs/skill-map surfacing and Pi marker validation. |
