...
Active milestone: **v2.65 Functional-First Agent Guidance** — Phases 279–280 complete; Phase 281 ready to plan after Phase 280 merge gate. Phase 279 created `docs/PALS-FUNCTIONAL-FIRST-AGENT-GUIDANCE-CONTRACT.md` as the authoritative v2.65 implementation boundary; Phase 280 added compact generated `AGENTS.md`/init Engineering Principles and installed-resource marker checks while preserving project-convention authority. Latest completed milestone: **v2.64 Module Instruction Audit + Context-Efficiency Rewrite** closed 2026-05-12 via PR #196 (`340eee03`). Prior milestone: **v2.63 Workflow Instruction Audit + Context-Efficiency Rewrite** closed 2026-05-10 via PR #188 (`df56ece1`).
...
- v2.64 rewrote PALS module instruction sources (base/dispatch, core enforcement, advisory, domain optional cohorts) for context efficiency, semantic enforcement, and lifecycle compatibility, and added executable semantic-guardrail helpers (`tests/helpers/module_instruction_semantics.sh`) that reject marker-only module-instruction validation by construction; PLAN/APPLY/UNIFY remain authoritative for module rewrites.
...
| v2.65 Functional-First Agent Guidance | In progress (2 of 5 phases complete) — Phases 279–280 complete; Phase 281 ready to plan after merge gate | Adds practical “functional-first, not functional-only” agent coding guidance without turning PALS into an FP framework or overriding project conventions. Phase 279 created the authoritative implementation contract and preserved the research note as provenance; Phase 280 added generated AGENTS/init Engineering Principles plus installed-resource marker checks; remaining phases target brownfield mapping, TODD/RUBY guidance, and optional ARCH advisory closure. |
...
Current milestone pointer: **v2.65 Functional-First Agent Guidance** — Phases 279–280 complete; Phase 281 ready to plan after merge gate. Source of truth for this milestone’s scope is `docs/PALS-FUNCTIONAL-FIRST-AGENT-GUIDANCE-CONTRACT.md`; the research note remains provenance/background.
...
*Last updated: 2026-05-13 after Phase 280 completion; v2.65 Phase 281 ready to plan after merge gate.*
...
*Created: 2026-03-11*
*Last updated: 2026-05-12 after v2.64 milestone completion; awaiting next milestone.*
