...
Usage: /pals:discuss <phase-number>
Example: /pals:discuss 10
```
Exit workflow.
...
**Accept:** "yes", "go", "plan" → run `/pals:plan`
</step>
...
- Ready for /pals:plan to consume
</output>
...
DO: Focus on user input. Use /pals:assumptions for Claude's analysis.
</anti_patterns>
